...
const departmentData = [
  { name: 'Cardiology', value: 285, color: '#0d9488' },
  { name: 'Orthopedics', value: 215, color: '#10b981' },
  { name: 'Neurology', value: 165, color: '#f59e0b' },
  { name: 'Pediatrics', value: 245, color: '#3b82f6' },
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={monthlyPatientData}>
              ...
              <Line type="monotone" dataKey="admitted" stroke="#10b981" strokeWidth={2} />
              <Line type="monotone" dataKey="discharged" stroke="#f59e0b" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 lg:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={operationsData}>
              ...
              <Tooltip contentStyle={{ backgroundColor: '#1f2937', border: '1px solid #374151' }} />
              <Legend />
              <Bar dataKey="surgeries" fill="#0d9488" radius={[8, 8, 0, 0]} />
              <Bar dataKey="emergencies" fill="#ef4444" radius={[8, 8, 0, 0]} />
              <Bar dataKey="procedures" fill="#3b82f6" radius={[8, 8, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
